...
public class LoanTest {
    ...
    public void saveLoanWithClientWithoutActiveLoansAndFreeGameAndDatesBetween14DaysShouldCreate() throws ParseException {
        //Al service le paso el LoanDto, debe buscar que el cliente solo tenga 2 o menos loans, que el juego no esté en otro loan activo y que las fechas sean en un rengo de 14 días
