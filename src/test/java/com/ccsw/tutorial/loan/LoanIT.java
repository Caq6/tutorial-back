...
public class LoanIT {
    ...
    public void findFirstPageWithFiveSizeWithoutFiltersShouldReturnFirstFiveResults() {
        ...
        ResponseEntity<Page<LoanDto>> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.POST, new HttpEntity<>(loanSearchDto), responseTypePage);
    ...
    public void findExistingClientFirstPageWithFiveSizeWithFiltersShouldReturnLoans() {
        ...
        ResponseEntity<Page<LoanDto>> response = restTemplate.exchange(getUrlWithParams(), HttpMethod.POST, new HttpEntity<>(loanSearchDto), responseTypePage, params);
