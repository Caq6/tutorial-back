...
public class ClientIT {
    ...
    @Test
    public void saveWithoutClientIdShouldCreateNewClient() {
    ...
    @Test
    public void saveExistingClientIdShouldUpdateClient() {
        ClientDto clientDto = new ClientDto();
        clientDto.setName(NEW_CLIENT_NAME);
        
        restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + EXISTING_CLIENT_ID, HttpMethod.PUT, new HttpEntity<>(clientDto), Void.class);
        ResponseEntity<List<ClientDto>> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.GET, null, responseType);
    ...
    @Test
    public void modifyNotExistingClientIdShouldInternalError() {
        ClientDto clientDto = new ClientDto();
        clientDto.setName(NEW_CLIENT_NAME);
        
        ResponseEntity<?> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + NOT_EXISTING_CLIENT_ID, HttpMethod.PUT, new HttpEntity<>(clientDto), Void.class);
        
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, response.getStatusCode());
    }
    
    @Test
    public void saveWithExistingNameShouldBadRequest() {
        ClientDto clientDto = new ClientDto();
        clientDto.setName(EXISTING_CLIENT_NAME);
        
        ResponseEntity<?> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.PUT, new HttpEntity<>(clientDto), Void.class);
    ...
    @Test
    public void deleteNotExistingClientIdShouldInternalError() {
        ResponseEntity<?>response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + NOT_EXISTING_CLIENT_ID, HttpMethod.DELETE, null, Void.class);
