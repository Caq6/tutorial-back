...
public class AuthorIT {
	...
	public void findFirstPageWithFiveSizeShouldReturnFirstFiveResults() {
		...
		authorSearchDto.setPageable(PageRequest.of(0, PAGE_SIZE));
		
        ResponseEntity<Page<AuthorDto>> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.POST, new HttpEntity<>(authorSearchDto), responseTypePage);
	...
	public void findSecondPageWithFiveSizeShouldReturnLastResult() {
		...
		AuthorSearchDto authorSearchDto = new AuthorSearchDto();
		authorSearchDto.setPageable(PageRequest.of(1, PAGE_SIZE));
    ...
    public void saveWithoutIdShouldCreateNewAuthor() {
          ...
          AuthorSearchDto authorSearchDto = new AuthorSearchDto();
          authorSearchDto.setPageable(PageRequest.of(0, (int) newAuthorSize));
	...
	public void deleteWithExistsIdShouldDeleteAuthor() {
	  ...
	  AuthorSearchDto authorSearchDto = new AuthorSearchDto();
	  authorSearchDto.setPageable(PageRequest.of(0, TOTAL_AUTHORS));
